 ...
 *
 * THE central mechanism that makes the cu panel work as a blob-imported disk
 ...
 *      so React is already available during eval.
 *
...
export function getHostReact(): typeof ReactNS {
  ...
  throw new Error(
    'cu extension: host React unavailable — the host must set globalThis.' +
      GLOBAL_KEY +
